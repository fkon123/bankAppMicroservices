...
@Tag(name = "CRUD REST APIs for Cards in microservicesBank", description = "CRUD REST APIs in microservicesBank to CREATE, UPDATE, FETCH AND DELETE card details")
@RestController
...
public class CardsController {
        ...
        @Operation(summary = "Create Card REST API", description = "REST API to create new Card inside microservicesBank")
        @ApiResponses({
