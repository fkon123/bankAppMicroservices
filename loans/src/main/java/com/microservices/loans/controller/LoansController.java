...
@Tag(name = "CRUD REST APIs for Loans in microservicesBank", description = "CRUD REST APIs in microservicesBank to CREATE, UPDATE, FETCH AND DELETE loan details")
@RestController
...
public class LoansController {
        ...
        @Operation(summary = "Create Loan REST API", description = "REST API to create new loan inside microservicesBank")
        @ApiResponses({
